$(document).ready(function() {
  ...
  var bandid = $('#bandA-element'.target).attr('data-id')
  ...
  function queryDBfunction (e) {
      ...
      var bandid = $('#bandA-img, #bandB-img, #bandA-name, #bandB-name, #bandA-results, #bandB-results').attr('band-id');
      console.log(bandid);
      ...
      $.getJSON(discogsApiUrl, params, function(response) {
        ...
        newThumb.css('background-image', 'url("' + thumbImg + bandaid + '")');
